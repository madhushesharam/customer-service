...
CMD ["sh", "-c", "opentelemetry-instrument --traces_exporter console --metrics_exporter console --logs_exporter console --service_name dice-server flask --app src/app.py run --host 0.0.0.0 -p 5000"]
